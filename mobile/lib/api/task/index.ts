...
export const GetAllTasksForUser = async (
  ...
  try {
    const response = await fetch(
      `${process.env.EXPO_PUBLIC_API_URL}/users/${userId}/tasks`,
      {
        method: "GET",
        headers: {
...
export async function GetTaskByIdForUser(
  ...
  try {
    const response = await fetch(
      `${process.env.EXPO_PUBLIC_API_URL}/tasks/${taskId}/tasks/${userId}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export async function SubmitAnswerForTask(
  ...
  try {
    ...
    const response = await fetch(
      `${process.env.EXPO_PUBLIC_API_URL}/tasks/submit-answer`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
